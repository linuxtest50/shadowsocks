...
func main() {
	...
	var printVer bool
	var remoteIP, remotePort, mode string

	flag.BoolVar(&printVer, "version", false, "print version")
	flag.StringVar(&configFile, "c", "config.json", "specify config file")
	flag.BoolVar((*bool)(&debug), "d", false, "print debug message")
	flag.StringVar(&cmdLocal, "L", "127.0.0.1", "Local listen IP Address")
	flag.StringVar(&remoteIP, "A", "", "Remote IP Address")
	flag.StringVar(&remotePort, "P", "", "Remote Port")
	flag.StringVar(&mode, "M", "tcp", "Mode, (tcp,udp,tcpudp)")
	...
	listenAddr := fmt.Sprintf("%s:%s", cmdLocal, strconv.Itoa(config.LocalPort))
